...
- **Playwright mobile screenshot baseline** — 5 representative pages captured at 390×844 px (iPhone 14 portrait) in `tests/snapshots/baseline/` as a visual reference.
